# Paper Analysis: Fairness in Job Recommendation under Quantity Constraints

**Source:** The PIKE Group (per batch manifest label; source_id `8c1b6d85-d596-43e5-b100-59d35db770a2`)
...
**Venue:** The PIKE Group (per manifest label only, unverified)
...
- **title:** Fairness in Job Recommendation under Quantity Constraints (per batch manifest label)
- **authors or organization:** Unknown — extraction failed
- **year:** Unknown — extraction failed
- **venue or type:** The PIKE Group (per manifest label only, unverified)
