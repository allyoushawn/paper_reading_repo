# Paper Analysis: Designing labor market recommender systems

**Source:** Semantic Scholar index (per batch manifest label; source_id `6f04017d-4dbc-4a84-8c27-9535ec633f58`)
...
**Venue:** Unknown — extraction failed (manifest label "Semantic Scholar" is an index/aggregator, not a venue)
...
- **title:** Designing labor market recommender systems (per batch manifest label)
- **authors or organization:** Unknown — extraction failed
- **year:** Unknown — extraction failed
- **venue or type:** Unknown — extraction failed (indexed via Semantic Scholar, not itself a venue)
