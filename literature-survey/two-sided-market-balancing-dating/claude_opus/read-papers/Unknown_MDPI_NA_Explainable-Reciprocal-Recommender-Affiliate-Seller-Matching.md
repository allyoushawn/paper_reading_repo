# Paper Analysis: Explainable Reciprocal Recommender System for Affiliate-Seller Matching

**Source:** MDPI (per batch manifest label; source_id `1c575967-a9b1-455b-b600-55b4e8c63b9a`)
...
**Venue:** MDPI (per manifest label only, unverified)
...
- **title:** Explainable Reciprocal Recommender System for Affiliate-Seller Matching (per batch manifest label)
- **authors or organization:** Unknown — extraction failed
- **year:** Unknown — extraction failed
- **venue or type:** MDPI (per manifest label only, unverified)
