...
| Spillover-contained CBR | Min et al., *Towards Reliable Social A/B Testing: Spillover-Contained Clustering with Robust Post-Experiment Analysis*, RecSys 2026; Kuaishou | Cluster, not touch | LT-7 ATE | Balanced Louvain CBR; CUPAC | 2% traffic; CBR LT-7 +0.133% vs UBR +0.049% | 3/0/2/1 = **6** | n/a | n/a | n/a |
| Cascade Reward Representation | Xia et al., *Alignment + Accuracy: The Cascade Reward Representation for Preranking*, RecSys 2026; Pinterest | Prerank candidate set | Homefeed/sitewide save rate | Impressed vs unimpressed split | Homefeed save +1.43% vs accuracy-only | 3/0/1/1 = **5** | n/a | n/a | n/a |
...
| Downstream rewards | Wang et al., *Long-term User Engagement Optimization through Model-agnostic Downstream Rewards Learning*, arXiv 2026 / RecSys 2026; Pinterest | Candidate score | Downstream session behavior | User-prevalence normalization | Multiple live surfaces; number not reported | 2/1/0/1 = **4** | n/a | n/a | n/a |
...
| PROMISE process rewards | Guo et al., *PROMISE: Process Reward Models Unlock Test-Time Scaling Laws in Generative Recommendations*, RecSys 2026; Kuaishou | SID prefix | Retrieval/watch time | None identified | ~20M users/group; app usage +0.121% | 3/1/0/0 = **4** | n/a | n/a | n/a |
| STEPS agentic push | Zhang et al., *A Self-Triggered Agentic Push Recommendation System*, RecSys 2026; ByteDance | Push decision | UAD; disablement | Bellman value-guided DT | Douyin >1B users; UAD +0.2843% | 3/0/0/1 = **4** | n/a | n/a | n/a |
| MODE | Tomita, *MODE: Mutual Optimality in Direct Effects of Reciprocal Recommendations in Matching Markets*, RecSys 2026; CyberAgent | Candidate list | Expected matches | PBM examination | Dating logs ~1k×1k; not deployed A/B | 1/0/1/2 = **4** | n/a | n/a | n/a |
| Control-function ULTR | Islam, Vasilaky, and Zheleva, *A Control Function Framework for Mitigating Position Bias in Learning to Rank Systems*, RecSys 2026 | Click/rank | Click relevance | Two-stage control function | Baidu-ULTR logs | 1/0/2/1 = **4** | n/a | n/a | n/a |
| UniShare | Wang et al., *UniShare: A Unified Framework for Joint Video and Receiver Recommendation in Social Sharing*, RecSys 2026; Kuaishou | Video/receiver candidate | Share probability | Hierarchical negatives | Deployed Kuaishou | 3/0/0/1 = **4** | n/a | n/a | n/a |
| Live-streaming MOR | Gu et al., *Multi-Objective Ranking for Live-Streaming*, RecSys 2026; Twitch | Channel candidate | 14-day delayed play/follow | Segment scalarization | Production; p99 <110ms | 3/0/0/1 = **4** | n/a | n/a | n/a |
| TSMOO | Kalagarla et al., *TSMOO: Solving multi-objective experimentation with constrained Thompson sampling*, RecSys 2026; Amazon | Experiment arm | Multi-metric launch | Constrained TS; uplift novelty | Simulation replay 93–94% / 63–66%; landing page | 1/0/1/1 = **3** | n/a | n/a | n/a |
| GPBM | Knyazev et al., *Generalized position-based model*, RecSys 2026; Amazon Music | Rank position | OPE policy value | Learned position weights | Landing-page ingest; no PDF numbers | 0/0/1/1 = **2** | n/a | n/a | n/a |
| Residual dominance | Kozaki et al., *Residual Dominance as a Structural Account of Last-Item Reliance*, RecSys 2026 | Sequence position (diagnostic) | Next-item HR/NDCG | None | Public datasets only | 0/0/0/1 = **1** | n/a | n/a | n/a |
| DeltaGate | Ding et al., *Zero-Observation User Reactivation with Gap-Driven Dimensional Gating*, RecSys 2026; Huawei | User embedding | Next-item after gap | None | Amazon review offline | 0/0/0/1 = **1** | n/a | n/a | n/a |
| Convergent validity | Parajuli, Vaez Barenji, and Ekstrand, *On the Convergent Validity of Offline Evaluation Designs*, RecSys 2026 | None | Offline NDCG vs dense qrels | None | Academic | 0/0/0/0 = **0** | n/a | n/a | n/a |
| Causal transformer MTA (stub) | Zhang and Gao, RecSys 2026 advertising MTA | Advertising touch (claimed) | Conversion (claimed) | Dual debiasing (unverified) | Paywalled; unscored | unscored | n/a | n/a | n/a |

## RecSys 2026 addendum note

None of G28–G41 outranks ALM-MTA, LinkedIn DDA, RevisitMTL, or IURO+ on the composite. Spillover-contained CBR (score 6) is an experiment device for v3, not a labeler. MODE is the second dating-vertical method after MRet and remains NOT attribution.
